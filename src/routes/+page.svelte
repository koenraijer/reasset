<script>
  ...
  <div class="container h-full mx-auto flex flex-col flex-nowrap justify-center pt-10 pb-40 items-center">
	...
	{:else}
	<div class="bg-surface-50-900-token !text-surface-900-50-token w-full">
		<Accordion autocollapse>
			<AccordionItem class="">
				<svelte:fragment slot="lead"></svelte:fragment>
				<svelte:fragment slot="summary">WTF is this?</svelte:fragment>
				<svelte:fragment slot="content">Hi</svelte:fragment>
			</AccordionItem>
			<AccordionItem class="">
				<svelte:fragment slot="lead"></svelte:fragment>
			...
			<AccordionItem class="">
				<svelte:fragment slot="lead"></svelte:fragment>
				<svelte:fragment slot="summary">What do I use it for?</svelte:fragment>
				<svelte:fragment slot="content">Hi</svelte:fragment>
			</AccordionItem>
		</Accordion>
	</div>
	<div class="table-container">
		...
		<table class="table table-interactive">
			<thead>
				<tr class="text-lg bg-secondary-400 text-white">
					<th class="text-center">Assets</th>
					<th class="text-center">Current Value</th>
					<th class="text-center transition-colors duration-300 rounded-lg">Target allocation (%)</th>
			...
			<tfoot>
				<tr class="bg-secondary-400 text-white" >
					<th colspan="1">New Portfolio Total</th>
					<td class="text-center relative">
						{portfolioSum}</td>
					<td colspan="2" class="">
						<button class="ml-48" on:click={generate}>Generate</button>
					</td>
				</tr>
				{#if generated}
					<tr>
